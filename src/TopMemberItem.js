        ...
        memberContent = (
            <div className="basis-1/2">
                <div class="relative mb-8">
                    <div class="w-full">
                        <img class="rounded-full mx-auto mb-3 w-10/12 border-8 border-emerald-500 p-1" src={member.avatar} />
                    </div>
                ...
                <h2 class="text-2xl text-emerald-500 font-medium">{member.name}</h2>
            </div>
        );
    } else {
        memberContent = (
            <div className={member.rank == 2 ? "basis-1/4 self-end order-first" : "basis-1/4 self-end"}>
                ...
                <h2 class="text-2xl text-emerald-500">{member.name}</h2>
